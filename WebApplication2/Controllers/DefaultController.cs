...
namespace WebApplication2.Controllers
{
    ...
    {
        // GET: Default
        public ActionResult Index(string IP,string DB,string storecode, string templatenumber, string serialnumber, string documentno)
        {
            String connectionStr = ConfigurationManager.ConnectionStrings["defaultConnect"].ConnectionString;
            connectionStr = connectionStr.Replace("IPAddress",IP);
            connectionStr = connectionStr.Replace("Database", DB);
